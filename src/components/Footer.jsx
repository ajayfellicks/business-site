...
const Footer = () => {
  return (
    <div>
      <div className="flex flex-col relative mt-20 overflow-hidden pb-10">
        <img
          src={FooterDesignT}
          alt=""
          className="top-0 left-0 absolute opacity-50"
        />
        <div className=" grid px-10 md:grid-cols-[3fr_1fr]">
          <div className="z-20 ">
          ...
          <div className="z-20 md:flex md:justify-center md:items-center grid mb-20">
            <button className=" text-2xl md:px-5 bg-purple-60  py-[1rem] mt-20 mx-8 rounded-2xl border-solid border-[1px] border-purple-70 hover:bg-purple-70 hover:border-purple-60 ">
              Explore Properties
            </button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 grid-rows-[1fr_auto_auto_auto] mt-20 pb-20 md:grid-cols-[500px_1fr_1fr_1fr_1fr_1fr] md:grid-rows-1">
        <div className="mx-10 col-start-1 col-end-3 row-start-1 row-end-2 mb-20 md:col-start-1 md:col-end-2 md:row-start-1 md:row-end-2 md:ml-20">
        ...
        <div
          className="col-start-1 col-end-2 row-start-2 row-end-3 mx-10 pb-10 border-b-[1px] md:border-none border-grey-50
        md:col-start-2 md:col-end-3 md:row-start-1 md:row-end-2 md:justify-self-center"
        >
        ...
        <div className="col-start-2 col-end-3 row-start-2 row-end-3 mx-10 pb-10 md:justify-self-center  border-b-[1px] md:border-none border-grey-50 md:col-start-3 md:col-end-4 md:row-start-1 md:row-end-2 ">
        ...
        <div className="col-start-1 col-end-2 row-start-3 row-end-4 mx-10 pb-10 md:justify-self-center pt-10 border-b-[1px] md:pt-0 md:border-none border-grey-50 md:col-start-4 md:col-end-5 md:row-start-1 md:row-end-2">
        ...
        <div className="col-start-2 col-end-3 row-start-3 row-end-5 mx-10 pb-10 pt-10 md:justify-self-center border-b-[1px] md:pt-0 md:border-none border-grey-50 md:col-start-5 md:col-end-6 md:row-start-1 md:row-end-2 ">
        ...
        <div className="col-start-1 col-end-2 row-start-4 row-end-5 mx-10 pb-10 md:justify-self-center pt-10 border-b-[1px] border-grey-50 md:border-none md:pt-0 md:col-start-6 md:col-end-7 md:row-start-1 md:row-end-2">
      ...
      <div className="bg-grey-10 py-10 md:hidden">
      ...
      <div className="bg-grey-10 py-12 hidden md:flex justify-between px-20">
