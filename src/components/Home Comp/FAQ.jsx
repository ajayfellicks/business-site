      ...
      {faqData.slice(page * 1 - 1, page * 1).map((element, index) => {
        return (
          ...
          >
            ...
            <p className="font-medium text-[1.5rem]  text-grey-60 mb-10 md:mb-20">
              {element.description}
            </p>
      ...
      <div className="hidden md:grid md:grid-cols-3">
        {faqData.slice(page * 3 - 3, page * 3).map((element, index) => {
          return (
            ...
            >
              <h1 className="text-5xl font-semibold mb-20 mt-10">
                {element.title}
              </h1>
              <p className="text-4xl text-grey-60 font-medium mb-8 leading-[3.5rem]">
                {element.description}
              </p>
              <button className="hover:bg-main px-[4rem]  py-[2rem] md:py-[1.5rem] md:px-[1.5rem] rounded-xl border-solid border-[1px] hover:border-grey-15 bg-grey-8 border-grey-20 text-3xl">
                Read More
              </button>
            </div>
          );
